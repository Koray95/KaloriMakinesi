...
namespace KaloriUygulama
{
    public partial class UygulamaAnaForm : Form
    {
        ...
        {
            openChildForm(new GunSonuRaporuForm());
            hideSubMenu();
        }
        private void btnYemekKategoriRapor_Click(object sender, EventArgs e)
        {
            openChildForm(new YemekKategoriRaporForm());
            hideSubMenu();
        }

        private void btnHaftalikAylikKiyas_Click(object sender, EventArgs e)
        {
            openChildForm(new HaftalikAylikKiyasForm());
            hideSubMenu();
        }
        #endregion
