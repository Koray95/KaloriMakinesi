...
namespace KaloriUygulama
{
    public partial class YemekEkleForm : Form
    {
        ...
        private void txtYemekAra_TextChanged(object sender, EventArgs e)//TODO Arama tuşu koyup devamlı db'yi yormak yerine ara'ya basınca aratabiliriz(diyetkolik)
        {
